...
/// </summary>
public
ref class Newton : public System::Windows::Forms::Form {
public:
  Newton(void) {
    InitializeComponent();
    //
...
private:
  System::Windows::Forms::TextBox ^ xx_value;
...
#pragma region Windows Form Designer generated code
  ...
  void InitializeComponent(void) {
    ...
    this->label1->Font = (gcnew System::Drawing::Font(
        L"Tahoma", 16.2F, System::Drawing::FontStyle::Regular,
    ...
    this->label1->Click +=
        gcnew System::EventHandler(this, &Newton::label1_Click);
    //
    // dataGrid
    //
    this->dataGrid->AutoSizeColumnsMode =
        System::Windows::Forms::DataGridViewAutoSizeColumnsMode::Fill;
    this->dataGrid->AutoSizeRowsMode =
        System::Windows::Forms::DataGridViewAutoSizeRowsMode::AllCells;
    this->dataGrid->ColumnHeadersHeightSizeMode = System::Windows::Forms::
    ...
    this->dataGrid->CellContentClick +=
        gcnew System::Windows::Forms::DataGridViewCellEventHandler(
            this, &Newton::dataGrid_CellContentClick);
    //
    // btnSubmit
    //
    ...
    this->btnSubmit->Click +=
        gcnew System::EventHandler(this, &Newton::btnSubmit_Click);
    //
    // label2
    //
    ...
    this->label2->Click +=
        gcnew System::EventHandler(this, &Newton::label2_Click);
    //
    // xx_value
    //
    ...
    this->xx_value->TextChanged +=
        gcnew System::EventHandler(this, &Newton::xx_value_TextChanged);
    //
    // richTextBox1
    //
    ...
    this->richTextBox1->Font = (gcnew System::Drawing::Font(
        L"Tahoma", 10.2F, System::Drawing::FontStyle::Regular,
        System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
    ...
    this->richTextBox1->TextChanged +=
        gcnew System::EventHandler(this, &Newton::richTextBox1_TextChanged);
    //
    // button1
    //
    this->button1->Font = (gcnew System::Drawing::Font(
        L"Tahoma", 12, System::Drawing::FontStyle::Regular,
        System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
    ...
    this->button1->Click +=
        gcnew System::EventHandler(this, &Newton::button1_Click);
    //
    // Newton
    //
    ...
    this->Font = (gcnew System::Drawing::Font(
        L"Tahoma", 7.8F, System::Drawing::FontStyle::Regular,
        System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
    this->Name = L"Newton";
    this->Text = L"MyForm1";
    (cli::safe_cast<System::ComponentModel::ISupportInitialize ^>(
...
#pragma endregion
  ...
  /**
   * @brief Event handler for the 'Run' button.
   *
   * Reads data points from the DataGridView, validates input (numeric checks,
   * distinction checks, min/max points), and calls the Divided Difference
   * Interpolator.
   */
private:
    ...
    try {
      for (int i = 0; i < dataGrid->Rows->Count - 1; i++) {
        if (dataGrid->Rows[i]->Cells[0]->Value != nullptr &&
          ...
          try {
            System::String ^ managedStrx =
                dataGrid->Rows[i]->Cells[0]->Value->ToString();
            double x = Helper::TableHandler(managedStrx, &Flagx);

            System::String ^ managedStry =
                dataGrid->Rows[i]->Cells[1]->Value->ToString();
            double y = Helper::TableHandler(managedStry, &Flagy);

            if (Flagy == false || Flagx == false) {
              MessageBox::Show("Invalid numeric value in row " + i,
            ...
            MessageBox::Show("An error occurred in row: " + i + " " +
          ...
          MessageBox::Show("Please fill all X and Y values.", "Warning",
      ...
      if (!Double::TryParse(xx_value->Text, xx)) {
        MessageBox::Show("Please enter a valid X value to evaluate.", "Warning",
                         MessageBoxButtons::OK, MessageBoxIcon::Warning);
        richTextBox1->Clear();
        return;
      }
      ...
      MessageBox::Show("An error happened when parsing the equation, Make sure "
                       "to enter a vaild equation.",
...
private:
  System::Void dataGrid_CellContentClick(
...
private:
  System::Void xx_value_TextChanged(System::Object ^ sender,
                                    System::EventArgs ^ e) {}
